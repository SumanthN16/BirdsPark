        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Add Bird</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="card p-5">
                            <form method="POST" action="AdminBack.php?action=add_bird" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="textInput">Kingdom</label>
                                            <input type="text" id="Kingdom" class="form-control"
                                                placeholder="Kingdom " name="Kingdom">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="Phylum" class="form-control"
                                                placeholder="Phylum" name="Phylum">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="Family" class="form-control"
                                                placeholder="Family" name="Family">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
